...
sub get_deploy_config {
    ...
    my $config = {
        ...
        team          => 'devops',
        docs          =>
"Auto-generated deployment configuration for $resource_type resource.",
    };
    ...
    my %type_configs = (
        'vpc' => {
            ...
            docs          =>
"VPC provides the foundational networking layer for all resources.",
        },
        'iam' => {
            ...
            docs     =>
              "IAM roles and policies provide security and access control.",
        },
        'security-group' => {
        ...
        'eks-nodes' => {
            ...
            tags         => { type => 'compute', layer => 'platform' },
            docs         =>
"EKS node groups provide compute capacity for Kubernetes workloads.",
        },
        'rds' => {
