# external-s3-backend Template

Generated: 2025-08-31
Category: storage
Terraform Module: terraform-aws-modules/../../../../modules/external-s3-backend-data

## Description

This template creates AWS external-s3-backend resources using Terragrunt.

## Usage

```bash
# Create external-s3-backend resource
./manage.pl add resource "external-s3-backend" -e <env> -r <region>

# For zone-level resources
./manage.pl add resource "external-s3-backend" -e <env> -r <region> -z <zone>
```
...
- Resource-specific Perl module (external-s3-backend/Resource.pm)
...
- [AWS external-s3-backend Documentation](https://docs.aws.amazon.com/)
