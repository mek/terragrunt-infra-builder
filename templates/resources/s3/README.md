...
Category: storage
Terraform Module: terraform-aws-modules/s3-bucket

## Description

This template creates AWS s3 resources using Terragrunt.

## Usage

```bash
# Create s3 resource
./manage.pl add resource "s3" -e <env> -r <region>

# For zone-level resources
./manage.pl add resource "s3" -e <env> -r <region> -z <zone>
```
...
- Resource-specific Perl module (s3/Resource.pm)
...
- [AWS s3 Documentation](https://docs.aws.amazon.com/)
