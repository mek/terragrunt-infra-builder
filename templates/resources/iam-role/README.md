...
Category: security
Terraform Module: terraform-aws-modules/iam-role

## Description

This template creates AWS iam-role resources using Terragrunt.

## Usage

```bash
# Create iam-role resource
./manage.pl add resource "iam-role" -e <env> -r <region>

# For zone-level resources
./manage.pl add resource "iam-role" -e <env> -r <region> -z <zone>
```
...
- Resource-specific Perl module (iam-role/Resource.pm)
...
- [AWS iam-role Documentation](https://docs.aws.amazon.com/)
